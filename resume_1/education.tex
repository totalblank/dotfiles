...
\begin{longtable}[l]{@{}p{.125\textwidth} p{0.875\textwidth}}
    ...
    % 2020--25\footnotemark & \textbf{B.Sc.}, Industrial and Production Engineering, Bangladesh University of Engineering and Technology \\

    2020--25 & \textbf{B.Sc.} in Industrial and Production Engineering, Bangladesh University of Engineering and Technology \\

    2017-19 & \textbf{Higher School Certificate}, Munsi Manik Mia Degree College \\

    2015-17 & \textbf{Secondary School Certificate}, Bordia High School 
% \end{tabularx}
\end{longtable}
