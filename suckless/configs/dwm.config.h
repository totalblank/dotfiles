...
static const char *fonts[] = {"JetBrainMonoNerdFontMono:size=14"};
static const char dmenufont[] = "JetBrainMonoNerdFontMono:size=14";
...
static const Rule rules[] = {
    ...
    {"mpv", NULL, NULL, 0, 1, -1},      {"Zathura", NULL, NULL, 0, 1, -1},
    {"Inkscape", NULL, NULL, 0, 1, -1}, {"imv", NULL, NULL, 0, 1, -1},
    {"feh", NULL, NULL, 0, 1, -1},      {"R_x11", NULL, NULL, 0, 1, -1},
...
static const char bookmarks[] =
    "xdotool type $(grep -v '^#' ~/dotfiles/bookmarks | dmenu -i | cut -d' ' "
    "-f1)";

static const char add_bookmark[] =
